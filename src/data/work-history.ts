/*
 * The roles behind the work, as the about page lists them. Kept here rather
 * than in a route because it is the same material whether it is read on its
 * own page or summarised anywhere else.
 */
